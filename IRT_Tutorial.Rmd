...
## IRT Practice with R
Having introduced these basic notions on IRT, this tutorial reproduces code from Philip Masur's blog (2022, https://philippmasur.de/2022/05/13/how-to-run-irt-analyses-in-r/) and introduces three common IRT models: the 3PL, 2PL, and 1PL (Rasch) models.
